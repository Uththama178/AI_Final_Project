import os
from rag_core.document_loader import extract_text_from_pdf, extract_transcript_from_video, save_to_vector_store_debugger
...
def process_chapter_rag_quiz(chapter_title: str, pdf_path: str, video_path: str, chapter_id: int = 0) -> dict:
    """
    ...
    # 🚨 🆕 [RAG DEBUGGER] ඇස් දෙකෙන් දත්ත බලාගැනීම සඳහා JSON ෆයිල් එකකට සේව් කිරීම
    ...
    # 4. සැබෑ ලෙසම Memory Store එකට සේဝ် කිරීම
